...
(function () {
  ...
  // ใช้ภาพจริงที่ผู้ใช้ส่งมา (ตัดพื้นหลังกลางวงกลม + รอบนอกออกให้โปร่งใสแล้ว ด้วยการเลือก
  // สีพื้นหลังกรมท่าเข้มแบบ flood-fill เป็น alpha=0) วางไว้ที่ server/public/img/frames/
  ...
  const SPECIAL_FRAME_IMAGES = {
    ...
    frame_boss_1m:            { src: "/img/frames/frame-boss-dmg-1000000.png",   width: "192%", tx: "-50%",   ty: "-51.4%" },
    frame_boss_5m:            { src: "/img/frames/frame-boss-dmg-5000000.png",   width: "191%", tx: "-49.9%", ty: "-52%" },
  };
